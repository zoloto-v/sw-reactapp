...
interface SkeletonViewsProps {
  loading: boolean;
}

const SkeletonViews = ({ loading }: SkeletonViewsProps) => {
  return (
    <div className="post">
...
export const SkeletonTechPage = () => {
  ...
  return (
    <div className="App">
      ...
      <div className="mb-4">
        <h2>A Blog SkeletonViews</h2>
        <SkeletonViews loading={loading} />
      </div>
